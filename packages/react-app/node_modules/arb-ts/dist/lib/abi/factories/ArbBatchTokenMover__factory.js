...
class ArbBatchTokenMover__factory extends contracts_1.ContractFactory {
    constructor(linkLibraryAddresses, signer) {
        super(_abi, ArbBatchTokenMover__factory.linkBytecode(linkLibraryAddresses), signer);
    }
