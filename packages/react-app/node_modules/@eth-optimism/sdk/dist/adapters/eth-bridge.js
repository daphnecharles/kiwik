...
class ETHBridgeAdapter extends standard_bridge_1.StandardBridgeAdapter {
        ...
        this.populateTransaction = {
            ...
            deposit: async (l1Token, l2Token, amount, opts) => {
                ...
                if ((opts === null || opts === void 0 ? void 0 : opts.recipient) === undefined) {
                    return this.l1Bridge.populateTransaction.depositETH((opts === null || opts === void 0 ? void 0 : opts.l2GasLimit) || 200000, '0x', Object.assign(Object.assign({}, utils_1.omit((opts === null || opts === void 0 ? void 0 : opts.overrides) || {}, 'value')), { value: amount }));
                }
                else {
                    return this.l1Bridge.populateTransaction.depositETHTo(utils_1.toAddress(opts.recipient), (opts === null || opts === void 0 ? void 0 : opts.l2GasLimit) || 200000, '0x', Object.assign(Object.assign({}, utils_1.omit((opts === null || opts === void 0 ? void 0 : opts.overrides) || {}, 'value')), { value: amount }));
                }
            },
    ...
    async supportsTokenPair(l1Token, l2Token) {
        return (core_utils_1.hexStringEquals(utils_1.toAddress(l1Token), ethers_1.ethers.constants.AddressZero) &&
